...
video:  mains/main.cpp src/Mapper/Mapper.cpp
	g++ -std=c++20 -o main mains/main.cpp src/Mapper/Mapper.cpp $(NoWarn) -O3 && ./main r video def$(filename) 0$(h) 0$(w) 0$(fps)


image: mains/main.cpp src/Mapper/Mapper.cpp
	g++ -std=c++20 -o main mains/main.cpp src/Mapper/Mapper.cpp $(NoWarn) -O3 && ./main r image def$(filename) 0$(h) 0$(w)


test: unit_tests/test.cpp src/Mapper/Mapper.cpp
	g++ -std=c++20 -o test unit_tests/test.cpp src/Mapper/Mapper.cpp -Wall -Wextra && ./test
